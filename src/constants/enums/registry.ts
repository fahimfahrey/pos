...
import { REFUND_STATUS } from './refund-status'
...
export const STATIC_ENUM_VALUES: Record<EnumRegistryKey, readonly string[]> = {
  ...
  [ENUM_REGISTRY_KEY.PAYMENT_STATUS]: Object.values(PAYMENT_STATUS).map(String),
  [ENUM_REGISTRY_KEY.REFUND_STATUS]: Object.values(REFUND_STATUS).map(String),
}
